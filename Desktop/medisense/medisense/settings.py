"""
Django settings for medisense project.
...
SECRET_KEY = '+l(mlm!k54af_3!ga$=m1u1=36m8(%ws3-b0lz06nfrl5ukty2'
...
WSGI_APPLICATION = 'medisense.wsgi.application'
